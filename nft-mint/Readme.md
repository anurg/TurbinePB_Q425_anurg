...
2. Metaplex Candy machine - Creator can setup candy machine for their entire collection with Price fixed per NFT. Users can mint trustlessly NFT's and randomness ensures that NFT are fairly distributed regardless of rarity traits. Candy machine also saves creator from spending on Minting cost as Minting cost is paid by User minting NFT.
